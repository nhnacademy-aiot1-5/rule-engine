...
public class ReportScheduler {
    ...
    public void saveTodayPower() {
        if (cronFlag) {
            ...
            Map<LocalDateTime, Object> hourlyPowerDataMap = getQuery(dailyQuery, queryApi);
     ...
     */
    private Map<LocalDateTime, Object> getQuery(String dailyQuery,QueryApi queryApi) {
     ...
     * @return double
     */
    private double getTotalPower(Map<LocalDateTime, Object> hourlyPowerDataMap, List<LocalDateTime> midNights) {
